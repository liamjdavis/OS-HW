...
main:
	...
	##   Call...
	call		find_device 				# rv = &dt[console]
	##   Caller epilogue...
...
copy_kernel:
	...
	### COMPLETE THIS PROCEDURE: COPY THE KERNEL INTO RAM.
	# Copy ROM base address into t0
	lw t0, 4(a0)

	# Copy RAM base address into t1
	lw t1, 4(a1)

	# Copy ROM end address into t2
	lw t2, 8(a0)

copy_word:
	# Check if we reached end of ROM
	bge t0, t2, return
